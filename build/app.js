...
function handleDataTransferItems(items) {
  ...
  let imageFile = Array.prototype.find.call(items, e => e.kind == 'file' && e.type.match('image'));
...
function letUserDrawAndDownload(img) {
  ...
  pensizePreview.addEventListener('click', () => openColorPicker(currentColor, setColor));
